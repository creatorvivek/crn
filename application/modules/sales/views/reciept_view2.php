        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
    			...
    			<div class="receipt-header">
					...
					<div class="col-xs-6 col-sm-6 col-md-6 text-right">
						<div class="receipt-right">
							<h5><?= $company_name ?></h5>
							<p><?= $f_mobile ?> <i class="fa fa-phone"></i></p>
							<p><?= $f_email ?> <i class="fa fa-envelope-o"></i></p>
                            <p><?= $f_address ?> <i class="fa fa-location-arrow"></i></p>
							<p><?= $f_city.',  '. $f_pincode ?> <i class="fa fa-location-arrow"></i></p>
						</div>
					</div>
				</div>
            </div>
				...
				<div class="receipt-header receipt-header-mid">
					<div class="col-xs-8 col-sm-8 col-md-8 text-left">
						<div class="receipt-right">
							...
							<p><b>Mobile :</b> +91 <?= $mobile ?></p>
							<p><b>Email :</b> <?= $email ?></p>
                            <p><b>Address :</b> <?= $address ?></p>
							<p><b>City :</b> <?= $c_city .', '.$c_pincode ?></p>
						</div>
					</div>
            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9">Payment for <?= $payment_date ?></td>
