	...
	<header class="clearfix">
		<div class="container">
			...
			<div class="company-info">
				<h2 class="title"><?= $quotation['f_company_name'] ?></h2>
				<span><?= $quotation['f_address'].',' .$quotation['f_city'] .', '.$quotation['f_pincode'] ?></span>
				<span class="line"></span>
				<a class="phone" href="tel:<?= $quotation['f_mobile'] ?>"><?= $quotation['f_mobile'] ?></a>
				<span class="line"></span>
				<a class="email" href="mailto:<?= $quotation['f_email'] ?>"><?= $quotation['f_email'] ?></a>
			</div>
		</div>
	</header>
	...
	<section>
		<div class="details clearfix">
			<div class="client left">
				<p> TO:</p>
				<p class="name"><?= $quotation['c_name'] ?></p>
				<!-- <p>
					796 Silver Harbour,<br>
					TX 79273, US
				</p> -->
				<a href="mailto:<?= $quotation['c_email'] ?>"><?= $quotation['c_email'] ?></a>
			</div>
			<div class="data right">
				<!-- <div class="title">Invoice 3-2-1</div> -->
				<div class="date">
					Date of Quotation: <?= $quotation['created_at'] ?><br>
					<!-- Due Date: 30/06/2014 -->
				</div>
			</div>
		</div>
				...
				<table>
					...
					<tbody class="body">
						...
						<tr>
							...
							<td class="unit"><?= $row['unit_price'] ?></td>
				...
				<table class="grand-total">
					<tbody>
						<tr>
							...
							<td class="total"><?= $quotation['subtotal']  ?></td>
						</tr>
						<tr>
							<td class="no"></td>
							<td class="desc"></td>
							<td class="qty"></td>
							<td class="unit">TAX <?= $quotation['tax_percent'] ?>%:</td>
							<td class="total"><?= $quotation['tax'] ?></td>
						</tr>
						<tr>
							<td class="grand-total" colspan="5"><div><span>GRAND TOTAL:</span><?= $quotation['grand_total']  ?></div></td>
						</tr>
					</tbody>
				</table>
			</div>
