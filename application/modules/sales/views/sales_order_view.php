  ...
  <div class="col-md-8 right-padding-col8">
    <div class="card">
      <div class="body">
        ...
        <div class="row">
          <div class="col-md-4">
            <button class="btn btn-default btn-flat delete-btn" type="button" >Order id - <?= $invoice[0]['order_id'] ?></button>
            <!-- <br> -->
                  ...
                  <div class="body no-padding">
                    <div class="table-responsive">
                     ...
                     <?php  $tax_amount= $tax_amount+round(($invoice[0]['amount']  * (array_values($tax[$i]))[0])/100)     ?>
                          ...
                          <tr class="f_size"><td colspan="2" align="right" ><?=(array_keys($tax[$i]))[0] ?>(<?=(array_values($tax[$i]))[0] ?>%)</td><td colspan="2" class="text-right"><?= round(($invoice[0]['amount']  * (array_values($tax[$i]))[0])/100) ?></td></tr>
                      <?php } ?>
                          ...
                          <tr class="f_size">
                            ...
                            <td colspan="2" align="right">Paid</td><td colspan="2" class="text-right"><?= $invoice[0]['paid'] ?></td></tr>
                            <tr class="tableInfos f_size"><td colspan="2" align="right"><strong style="color:red">Due</strong></td><td colspan="2" class="text-right"><strong style="color:red"><?php echo round($invoice[0]['total']) -$invoice[0]['paid'] ?></strong></td></tr>
                          </tbody>
                        </table>
                      </div>
                      <br><br>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      foreach($payment as $pay) { 
                        ...
                        ?>
                        <tr>
                          <td align="center"><a href="<?= base_url() ?>sales/reciept_view/<?= $pay['payment_id'] ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i>&nbsp;<?= $pay['payment_id'] ?></a></td>
