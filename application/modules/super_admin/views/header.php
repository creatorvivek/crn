...
<head>
    ...
    <title><?= isset($title)?$title:'Super Admin' ?></title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0)">ENEXT IT</a>
            </div>
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                           ...
                           <!--  <li><a href="javascript:void(0);"><i class="material-icons">group</i>Followers</a></li>
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="<?= base_url()?>super_admin/logout"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if($this->uri->segment(1)=='home'){ echo 'active';} ?>" >
                        <a href="<?= base_url() ?>super_admin/dashboard">
                            <i class="material-icons">home</i>
                            <span>DASHBOARD</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url() ?>super_admin/add_seller">
                            <i class="material-icons">layers</i>
                            <span>ADD NEW SELLER</span>
                        </a>
                    </li>
                       <li>
                        <a href="<?= base_url() ?>super_admin/list_seller">
                            <i class="material-icons">layers</i>
                            <span>SELLER LIST</span>
                        </a>
                    </li>
                   <!--  <li class="<?php if($this->uri->segment(3)=='open'){ echo 'active';} ?>">
                        <a href="<?= base_url() ?>ticket/ticket_list/open">
                            <i class="material-icons">layers</i>
                            <span>OPEN TICKET</span>
                        </a>
                    </li>
                    <li class="<?php if($this->uri->segment(3)=='close'){ echo 'active';} ?>">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                             ...
                             <li class="<?php if($this->uri->segment(2)=='add_staff'){ echo 'active';} ?>">
                                        <a href="<?= base_url() ?>staff/add_staff">ADD STAFF</a>
                            </li>
                             <li class="<?php if($this->uri->segment(2)=='staff_list'){ echo 'active';} ?>">
                                        <a href="<?= base_url() ?>staff/staff_list">STAFF LIST</a>
                            </li>
                     ...
                     <li>
                        ...
                        <ul class="ml-menu">
                             ...
                             <li class="<?php if($this->uri->segment(2)=='add_staff'){ echo 'active';} ?>">
                                        <a href="<?= base_url() ?>account/add_staff">Generate Invoice</a>
                            </li>
                             <li class="<?php if($this->uri->segment(2)=='staff_list'){ echo 'active';} ?>">
                                        <a href="<?= base_url() ?>staff/staff_list">Invoice List</a>
                            </li>
                             <li class="<?php if($this->uri->segment(2)=='staff_list'){ echo 'active';} ?>">
                                        <a href="<?= base_url() ?>staff/staff_list">Ledger Report</a>
                            </li>

                           
                        </ul>
                    </li> -->
                    <!--  <li class="<?php if($this->uri->segment(3)=='add_category'){ echo 'active';} ?>">
                        <a href="<?= base_url() ?>category/add_category">
                            <i class="material-icons">layers</i>
                            <span>ADD CATEGORY</span>
                        </a>
                    </li>
                    <li class="<?php if($this->uri->segment(2)=='add_item'){ echo 'active';} ?>">
